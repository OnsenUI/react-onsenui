/*! react-onsenui v0.6.0 - Wed Jun 29 2016 17:21:31 GMT+0900 (JST) */
  ...
  var Page = function (_BasicComponent) {
    ...
    babelHelpers.createClass(Page, [{
      ...
      value: function render() {
        ...
        return React.createElement('ons-page', babelHelpers.extends({}, this.props, { _compiled: 'true' }), toolbar, React.createElement('div', { className: 'page__background' }, ' '), React.createElement('div', { className: 'page__content' }, this.props.children), React.createElement('div', { className: 'page__extra', style: { zIndex: 10001 } }, modal), bottomToolbar);
      }
    }]);
    return Page;
  }(BasicComponent);
